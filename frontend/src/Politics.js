...
let url;
    if(this.state.switch1 === true){
       url = 'https://backend-nodejs-273603.wl.r.appspot.com/guardianpolitics'
    }
    else{
       url = 'https://backend-nodejs-273603.wl.r.appspot.com/nytimespolitics'
    }
