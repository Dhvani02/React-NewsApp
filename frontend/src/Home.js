...
handleSwitchChange = nr => () => {
  ...
  //collapse hamburger menu on switch change
  document.getElementById('navbarSupportedContent').classList.remove('show')
}
 componentDidMount() {
let url;
    if(this.state.switch1 === true){
       url = 'https://backend-nodejs-273603.wl.r.appspot.com/guardian'
    }
    else{
       url = 'https://backend-nodejs-273603.wl.r.appspot.com/nytimes'
    }
